defmodule ConteurApp.Api.StoryView do
  use ConteurApp.Web, :view

  def render("index.json", %{stories: stories}) do
    %{data: render_many(stories, ConteurApp.Api.StoryView, "story.json")}
  end
  
  def render("index.json", %{stories: stories, event_ids: event_ids}) do
    %{data: render_many(stories, ConteurApp.Api.StoryView, "story.json", %{event_ids: event_ids})}
  end

  def render("show.json", %{story: story}) do
    %{data: render_one(story, ConteurApp.Api.StoryView, "story.json")}
  end
  
  def render("show.json", %{story: story, event_ids: event_ids}) do
    %{data: render_one(story, ConteurApp.Api.StoryView, "story.json", %{event_ids: event_ids})}
  end
